...
tags: [선형대수, 수학, 특이값 분해]
math: true
hreflang_en: /posts/8-1-svd-definition-en/
---
...
![SVD 공식 A = UΣV^T 시각화](https://cdn.jsdelivr.net/gh/rse112/math-animations@main/media/gifs/8_1_SVDFormula.gif)
...
![SVD 구성요소 U, Σ, V 시각화](https://cdn.jsdelivr.net/gh/rse112/math-animations@main/media/gifs/8_1_SVDComponents.gif)
